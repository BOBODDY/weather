...
import com.boboddy.weather.util.LocalWeather.CurrentCondition;
import com.boboddy.weather.util.LocalWeather.Data;

public class WwoApi {
    public static final boolean LOGD = true;

    //My api key
    private static final String key="6e4v8ejkwwkmadvb6mexn8v9";
